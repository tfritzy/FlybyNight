	...
	Category
	{
		...
		Subshader
		{
			Pass
			{
				...
				#pragma shader_feature _ _CFXR_LIGHTING_DIRECT _CFXR_LIGHTING_INDIRECT _CFXR_LIGHTING_ALL
				#pragma shader_feature _ _CFXR_LIGHTING_WPOS_OFFSET
				#pragma shader_feature _ _CFXR_LIGHTING_BACK
