public static class Constants
{
    ...
    public const int NUM_COLUMNS_RENDERED = 150;
    ...
    public const int DISTANCE_BETWEEN_SAVES = DIST_BETWEEN_OBSTACLES * 16 + DIST_BETWEEN_OBSTACLES / 2;
    public const int COLORS_PER_CYCLE = 16;
    public const int DIST_BETWEEN_OBSTACLES = 32;
